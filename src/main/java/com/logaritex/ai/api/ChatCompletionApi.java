...
public class ChatCompletionApi {
	...
	public record Embedding(
		 ...
		 * @param embedding The embedding vector, which is a list of floats. The length of vector depends on the model.
		 */
		public Embedding(Integer index, List<Float> embedding) {
	...
	/**
	 * Wrapper for API's list responses.
	 *
	 * @param <T> Type of the entities in the data list.
	 * @param object Must have value "list".
	 * @param data List of entities.
	 * @param firstId The ID of the first entity in the data list.
	 * @param lastId The ID of the last entity in the data list.
	 * @param hasMore Whether there are more entities available.
	 */
	@JsonInclude(Include.NON_NULL)
	 ...
	 * @return Returns list of {@link Embedding} wrapped in {@link DataList}.
	 ...
	 */
	public <T> DataList<Embedding> embeddings(EmbeddingRequest<T> embeddingRequest) {
